...
const ProductDetails = () => {
  ...
  return (
    <motion.div className="container mx-auto p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <motion.div className="flex flex-col gap-1" initial={{ x: -100 }} animate={{ x: 0 }}>
          <p className="bg-red-200 text-red-600 px-2 rounded-full inline-block w-fit">{data?.brandName}</p>
          <h2 className="text-xl lg:text-2xl font-medium">{data?.productName}</h2>
